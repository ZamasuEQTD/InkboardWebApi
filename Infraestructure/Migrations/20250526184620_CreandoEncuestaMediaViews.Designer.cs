...
namespace Infraestructure.Migrations
{
    ...
    [Migration("20250526184620_CreandoEncuestaMediaViews")]
    partial class CreandoEncuestaMediaViews
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Domain.Encuestas.Models.Encuesta", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid")
                        .HasColumnName("id");
            ...
            modelBuilder.Entity("Domain.Comentarios.Models.Comentario", b =>
                {
                    ...
                    b.OwnsOne("Domain.Core.Models.AutorRole", "Autor", b1 =>
                        {
                            ...
                            b1.Property<string>("Role")
                                .IsRequired()
                                .HasColumnType("text")
                                .HasColumnName("autor_role");

                            b1.Property<string>("Username")
                                .IsRequired()
                                .HasColumnType("text")
                                .HasColumnName("autor_username");
            ...
            modelBuilder.Entity("Domain.Encuestas.Models.Encuesta", b =>
                {
                    b.OwnsMany("Domain.Encuestas.Models.Voto", "Votos", b1 =>
                        {
                            b1.Property<Guid>("Id")
                                .HasColumnType("uuid")
                                .HasColumnName("id");
                    ...
                    b.OwnsMany("Domain.Encuestas.Models.Respuesta", "Respuestas", b1 =>
                        {
                            b1.Property<Guid>("Id")
                                .HasColumnType("uuid")
                                .HasColumnName("id");
            ...
            modelBuilder.Entity("Domain.Hilos.Models.Hilo", b =>
                {
                    ...
                    b.HasOne("Domain.Encuestas.Models.Encuesta", null)
                        .WithOne()
