...
namespace Infraestructure.Migrations
{
    ...
    [Migration("20250120183023_AgregandoStatusSubcategoriaColAPortadaView")]
    partial class AgregandoStatusSubcategoriaColAPortadaView
    {
        /// <inheritdoc />
                    ...
                    b.OwnsMany("Domain.Hilos.Models.HiloInteraccion", "Interacciones", b1 =>
                        {
                            ...
                            b1.HasKey("Id")
                                .HasName("pk_hilo_interaccion");

                            b1.HasIndex("HiloId")
                                .HasDatabaseName("ix_hilo_interaccion_hilo_id");

                            b1.HasIndex("UsuarioId")
                                .HasDatabaseName("ix_hilo_interaccion_usuario_id");

                            b1.ToTable("hilo_interaccion", (string)null);

                            b1.WithOwner()
                                .HasForeignKey("HiloId")
                                .HasConstraintName("fk_hilo_interaccion_hilos_hilo_id");
                            ...
                            b1.HasOne("Domain.Usuarios.Models.Usuario", null)
                                ...
                                .OnDelete(DeleteBehavior.Cascade)
                                .IsRequired()
                                .HasConstraintName("fk_hilo_interaccion_asp_net_users_usuario_id");
                        });
